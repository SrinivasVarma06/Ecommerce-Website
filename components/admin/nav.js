        ...
        <div className="text-white p-5">
            <aside className=" ">
                ...
                <nav className="flex flex-col mt-10 gap-8">
                    ...
                    <Link href={"/products"} className={pathname==="/products"?activeLinks:inactiveLinks}>
                        {" "}
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                    ...
                    <Link href={"/orders"} className={pathname==="/orders"?activeLinks:inactiveLinks}>
                        {" "}
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                    ...
                    <Link href={"/settings"} className={pathname==="/settings"?activeLinks:inactiveLinks}>
                        {" "}
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
